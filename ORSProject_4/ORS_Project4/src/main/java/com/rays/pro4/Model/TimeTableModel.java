...
//			throw new ApplicationException("Exception : Exception in add timetable");
	...
	/**
	 * JDBC Implement checkBysemester().
	 * 
	 * @author Krishnkant Mandloi
	 *
	 */
	...
	/**
	 * JDBC Implement checkByCourseName().
	 * 
	 * @author Krishnkant Mandloi
	 *
	 */
