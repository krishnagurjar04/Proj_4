					 ...
					 <input type="text" name="firstName" placeholder="Enter First Name"
                       ...
                       <input type="text" name="LastName" placeholder="Enter Last Name"
						...
						&emsp; --%>
						  ...
						  <label>LoginId :</label> <input type="text" name="loginid" placeholder="Enter Login-Id"
						...
						<input type="number" name="mobileno" placeholder="enter your no" 
						value="<%=ServletUtility.getParameter("mobileno", request) %>"> --%>
						
						 <%-- <label>Date Of Birth :</label>
						<%=HTMLUtility.getList("dob", String.valueOf(bean.getDob()), ulist)%>
						&nbsp; --%> 
